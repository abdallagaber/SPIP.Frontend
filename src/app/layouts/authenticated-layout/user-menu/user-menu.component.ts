...
export class UserMenuComponent {
  ...
  readonly userInitials = computed(() => {
    const user = this.authStorage.session();
  ...
  private confirmLogout(): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        // The logout method already handles redirection to AUTH_ROUTES.login
        // So we don't need this.router.navigate here anymore.
      }
    });
  }
}
